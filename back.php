...
//to do:rewrite this little shit
//https://github.com/tomatodua/useful-php-scripts/blob/master/my-sql-export%20(backup)%20database.php
...
EXPORT_DATABASE('localhost', 'root', '', 'devsland');
?>